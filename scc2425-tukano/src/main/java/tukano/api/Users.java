...
public interface Users {
	 ...
	 */
	Result<String> createUser(TukanoUser user);
	 ...
	 */
	Result<TukanoUser> getUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<TukanoUser> updateUser(String userId, String pwd, TukanoUser user);
	 ...
	 *         BAD_REQUEST otherwise
	 */
	Result<TukanoUser> deleteUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<List<TukanoUser>> searchUsers(String pattern);
}
